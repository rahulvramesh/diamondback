...
<!-- jQuery UI styles -->
<link rel="stylesheet" href="<c:url value="/resources/jquery-ui.css">" id="theme">
<!-- Demo styles -->
<link rel="stylesheet" href="<c:url value="/resources/demo.css">">
<!--[if lte IE 8]>
...
<link rel="stylesheet" href="<c:url value="/resources/blueimp-gallery.min.css">">
<!-- CSS to style the file input field as button and adjust the Bootstrap progress bars -->
<link rel="stylesheet" href="<c:url value="/resources/jquery.fileupload.css">">
<link rel="stylesheet" href="<c:url value="/resources/jquery.fileupload-ui.css">">
...
<script src="<c:url value="/resources/tmpl.min.js">"></script>
<!-- The Load Image plugin is included for the preview images and image resizing functionality -->
<script src="<c:url value="/resources/load-image.all.min.js">"></script>
<!-- The Canvas to Blob plugin is included for image resizing functionality -->
<script src="<c:url value="/resources/canvas-to-blob.min.js">"></script>
<!-- blueimp Gallery script -->
<script src="<c:url value="/resources/jquery.blueimp-gallery.min.js">"></script>
<!-- The Iframe Transport is required for browsers without support for XHR file uploads -->
<script src="<c:url value="/resources/jquery.iframe-transport.js">"></script>
<!-- The basic File Upload plugin -->
<script src="<c:url value="/resources/jquery.fileupload.js">"></script>
<!-- The File Upload processing plugin -->
<script src="<c:url value="/resources/jquery.fileupload-process.js">"></script>
<!-- The File Upload image preview & resize plugin -->
<script src="<c:url value="/resources/jquery.fileupload-image.js">"></script>
<!-- The File Upload audio preview plugin -->
<script src="<c:url value="/resources/jquery.fileupload-audio.js">"></script>
<!-- The File Upload video preview plugin -->
<script src="<c:url value="/resources/jquery.fileupload-video.js">"></script>
<!-- The File Upload validation plugin -->
<script src="<c:url value="/resources/jquery.fileupload-validate.js">"></script>
<!-- The File Upload user interface plugin -->
<script src="<c:url value="/resources/jquery.fileupload-ui.js">"></script>
<!-- The File Upload jQuery UI plugin -->
<script src="<c:url value="/resources/jquery.fileupload-jquery-ui.js">"></script>
...
<script async="" src="<c:url value="/resources/cookieconsent.latest.min.js">"></script>
